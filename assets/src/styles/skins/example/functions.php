 ...
 */
function colorio_get_available_design_styles( $default_design_styles ) {

	$default_design_styles['brutalist'] = [
		'slug'           => 'brutalist',
...
add_filter( 'go_design_styles', 'colorio_get_available_design_styles' );
