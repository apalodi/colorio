...
namespace EightshiftBoilerplateVendor\EightshiftLibs\Blocks;

use EightshiftBoilerplateVendor\EightshiftLibs\Exception\InvalidBlock;
use EightshiftBoilerplateVendor\EightshiftLibs\Exception\InvalidManifest;
use EightshiftBoilerplateVendor\EightshiftLibs\Services\ServiceInterface;
...
abstract class AbstractBlocks implements ServiceInterface, RenderableBlockInterface
{
		...
		if (!$this->blocks) {
			...
			$blocks = array_map(
				function ($block) use ($settings) {
					...
					// Check if namespace EightshiftBoilerplateVendor\is defined in block or in global manifest settings.
	 ...
	 *
	 * @throws InvalidBlock Throws error if global manifest settings key namespace EightshiftBoilerplateVendor\is missing.
